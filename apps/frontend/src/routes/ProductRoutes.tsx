...
const FieldLeaderboardPage = lazyPlaceholderPage('FieldLeaderboardPage');
const ReportingPage = lazyPlaceholderPage('ReportingPage');
...
const ScoutTasksPage = lazyPlaceholderPage('ScoutTasksPage');
const DataManagerPage = lazyPlaceholderPage('DataManagerPage');
const ConnectionsPage = lazyPlaceholderPage('ConnectionsPage');
const FieldGroupsPage = lazyPlaceholderPage('FieldGroupsPage');
