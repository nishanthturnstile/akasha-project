...
_RESOURCESAT_LISS4_SOURCE_ID = "resourcesat-2a-liss4-mx70-l2"
_RESOURCESAT_LISS4_BHOONIDHI_COLLECTION = "ResourceSat-2A_LISS4-MX70_L2"
...
_RESOURCESAT_BOA_COLLECTION_ALIASES = {
    ...
    _RESOURCESAT_LISS4_SOURCE_ID: _RESOURCESAT_LISS4_SOURCE_ID,
    _RESOURCESAT_LISS4_BHOONIDHI_COLLECTION: _RESOURCESAT_LISS4_SOURCE_ID,
...
# docs/archive/sentinel-2-l2a-cog-prep-runbook.md). Source product:
