...
export function CommandPalette({
    ...
    return (
        <Command.Dialog
            ...
            overlayClassName="fixed inset-0 z-popover bg-background/60 backdrop-blur-sm animate-fade-in"
            contentClassName="glass fixed left-1/2 top-[18vh] z-popover w-[min(36rem,calc(100vw-2rem))] -translate-x-1/2 overflow-hidden rounded-lg p-0 animate-panel-in"
        >
